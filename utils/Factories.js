...
/*
    ...
    @return {string} user names concatenated by a '&' or "Empty Users" if no users
*/
const createChatNameFromUsers = (users, excludedUser = "") => {
    // console.log("createChatNameFromUsers: ", users.filter(u => u !== excludedUser).join(' & ') || "Empty Users");
